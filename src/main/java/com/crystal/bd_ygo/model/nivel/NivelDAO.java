...
public class NivelDAO {
	...
	public void atualizarNivel(Nivel nivel, String uuid){
		String sql = "UPDATE nivel " + 
			"SET nivelnumero = ? WHERE nivelid = ?::uuid";
		Object[] obj = new Object[2];
		obj[0] = nivel.getNivelNumero();
		obj[1] = uuid;
		jdbc.update(sql,obj);
	}

	public void deletarNivel(String uuid){
		String sql = "DELETE FROM nivel where nivelid=?::uuid";
