...
public class TipoDAO {
	...
	public void atualizarTipo(Tipo tipo, String uuid){
		String sql = "UPDATE tipo " + 
			"SET tiponome = ? WHERE tipoid = ?::uuid";
		Object[] obj = new Object[2];
		obj[0] = tipo.getTipoNome();
		obj[1] = uuid;
		jdbc.update(sql,obj);
	}

	public void deletarTipo(String uuid){
		String sql = "DELETE FROM tipo where tipoid=?::uuid";
